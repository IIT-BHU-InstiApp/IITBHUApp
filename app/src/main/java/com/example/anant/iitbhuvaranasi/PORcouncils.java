 ...
 */
public class PORcouncils extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_porcouncils, container, false);

        LinearLayout linearLayout = view.findViewById(R.id.councils_contact_container);
